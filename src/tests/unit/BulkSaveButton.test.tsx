...
describe("BulkSaveButton", () => {
  ...
  it("renders with correct label showing accepted count", () => {
    render(<BulkSaveButton selectedProposals={mockProposals} onSaveComplete={mockOnSaveComplete} />);
  ...
  it("does not save when there are no accepted proposals", () => {
    ...
    render(<BulkSaveButton selectedProposals={emptyProposals} onSaveComplete={mockOnSaveComplete} />);
